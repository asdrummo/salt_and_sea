...
class PreferencesControllerTest < ActionController::TestCase
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post :create, preference: { customer_id: @preference.customer_id, mackerel: @preference.mackerel, monkefish: @preference.monkefish, skate: @preference.skate, squid: @preference.squid }
    end
  ...
  test "should update preference" do
    put :update, id: @preference, preference: { customer_id: @preference.customer_id, mackerel: @preference.mackerel, monkefish: @preference.monkefish, skate: @preference.skate, squid: @preference.squid }
    assert_redirected_to preference_path(assigns(:preference))
  end
